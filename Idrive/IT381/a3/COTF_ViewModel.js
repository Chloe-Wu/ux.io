		...
		success: function(xml){
			...
			$(xml).find('computer').each(function(){
				var info=
					'<li data-id='
					+$(this).find("ID").text()
					+'><a href="#page1" class="ui-shadow-icon ui-btn ui-shadow ui-corner-all ui-btn-icon-right ui-icon-'+$(this).find("myicon").text()+'"><img src='
					+$(this).find("pic").text()
					+'><h1>Model: '
					...
					+'</p><p class="ui-li-aside"><b>'+$(this).find("status").text()+'</b></p></a></li>';
